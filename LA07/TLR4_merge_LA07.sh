...
grep -A 2 -B 1 --no-group-separator '^.\{95\}AACCGAAGTTACATCCCAGTG' \
	loci/expectedLength/reversePrimer/TLR4-1_exLen_Rprimer_LA07.fastq > 4_1.fastq

grep -A 2 -B 1 --no-group-separator '^.\{297\}TGTTCTGTTGGACTCAGCCA' \
	loci/expectedLength/reversePrimer/TLR4-2_exLen_Rprimer_LA07.fastq > 4_2.fastq
